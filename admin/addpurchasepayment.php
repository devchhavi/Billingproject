...
<html lang="en">
    ...
    if (isset($_GET['accountid'])) {
     ...
     $ResultAll = mysqli_query($link, "SELECT * FROM `purchase_payment` WHERE purchase_id='$accountid' order by id desc limit 1");
...
<!--                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Members</a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                     <?php $ramObj->add_purchaseproductpayment(); ?>
                               ...
                               <input type="text" name="p_balance"  id="p_balance" class="form-control"   placeholder=""readonly>
                                   ...
                                   <div class="col-lg-4">
                                                             ...
                                                             <button class="btn btn-primary btn-block waves-effect waves-light" name="add_purchaseproductpayment" type="submit">Submit</button>
