...
$p_discount = $_REQUEST['p_discount'];
 ...
 $result = mysqli_query($link, "INSERT INTO `stock_transfer_product_list` (`purchase_list_id`,`purchase_id`,`product_id`,`product_amount`,`Total_amount`,`Quantity`,`Discount`,`RectimeStamp`) VALUES (NULL,'$purchasetempid','$p_name','$p_price','$p_total','$p_quantity','$p_discount','$rectimestamp')");
