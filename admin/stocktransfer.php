...
<?php } else { ?>
    ...
    $query = "INSERT INTO `stock_transfer_temporary` (`RectimeStamp`) VALUES ('$rectimestamp')";
                  ...
                  $lastinsertid=mysqli_insert_id($link);  ?>
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box d-flex align-items-center justify-content-between">
                                        <h4 class="page-title mb-0 font-size-18">Stock Transfer</h4>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form action="" method="post">
                                                    ...
                                                    <div class="col-lg-2">
                                                     ...
                                                     <div class="col-lg-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="p_discount" value="10"  id="p_discount" class="form-control"  onkeyup="gettotal();" placeholder="discount(%)">
                                               ...
                                               <div class="row">
                                                 <?php $ramObj->add_stock_transfer_product(); ?>
                                                 <form action="" method="post">
                                    ...
                                    <div class="col-lg-4">
                                                             ...
                                                             <button class="btn btn-primary btn-block waves-effect waves-light" name="add_stock_transfer_product" type="submit">Submit</button>
    ...
    <script>
       ...
       function getprice() {
        ...
        function addproducttocart() {
            ...
            $.ajax({
                type: "POST",
                url: "minusproductfromcartst.php",
                data: { purchasetempid:val3,p_name:val,p_quantity:val5,p_price:val1,p_discount:val2,p_total:val4},
                success: function (data) {
