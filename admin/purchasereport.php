                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="page-title mb-0 font-size-18">Purchase Report</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody><?php
                               $query = "SELECT * FROM `purchase_product` where date(RectimeStamp) between '$startdate' and '$enddatedate'   ORDER BY RectimeStamp DESC";
        ...
        if ($rowcount > 0) {
            while ($row = mysqli_fetch_array($result)) {
                ?><tr>
                    ...
                    <td><?php
                        echo $row['Total_Amounts'];$total=$total+$row['Total_Amounts'];
                        ?></td>
