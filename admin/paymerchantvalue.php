...
<html lang="en">
  ...
  if ($rowcountall>0) {
     $RowAll = mysqli_fetch_array($ResultAll);
       $merchantvalue=$RowAll['Merchant_value'];
       $memberid=$RowAll['m_id'];
  }
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form action="" method="post">
                                                <div class="row">
                                                     <input type="hidden" name="merchantvalue" id="merchantvalue" value="<?php echo $merchantvalue;  ?>" />
                                               ...
                                               <div class="row">
                                                 ...
                                                 <form action="" method="post">
                                                         <input type="hidden" name="purchasetempids" id="purchasetempids" value="<?php echo $lastinsertid;  ?>" /> 
                                                          <input type="hidden" name="merchantvaluekey" id="merchantvaluekey" value="1" /> 
                                                 <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                      <div class="col-lg-4">
                                          <div class="form-group">
                                                            ...
                                                            <input type="text" name="p_namesss" required="" id="countrys" class="form-control"    placeholder="Enter Member Name or code" readonly="" value="<?php  echo $memberid; ?>">
                                     ...
                                     <div class="col-lg-4">
                                          <div class="form-group">
                                                            ...
                                                            <input type="text" name="" required="" id="" class="form-control"    placeholder="Enter Member Name or code" readonly="" value="Rs.<?php  echo $merchantvalue; ?>">
           ...
           function gettotal() {
            ...
            var val = document.getElementById('p_quantity').value;
              var val1 = document.getElementById('p_price').value;
                var val2 = document.getElementById('p_discount').value;

                var total1=val*val1;
                var discount=(total1*val2)/100;
                var total=total1-discount;
              ...
              var val1 = document.getElementById('p_price').value;
                var val2 = document.getElementById('p_discount').value;
                 var val4 = document.getElementById('p_total').value;
                  var val6 = document.getElementById('merchantvalue').value;

    
            $.ajax({
                type: "POST",
                url: "minusproductfrommerchant.php",
                data: { purchasetempid:val3,p_name:val,p_quantity:val5,p_price:val1,p_discount:val2,p_total:val4,merchantvalue:val6},
                success: function (data) {
       ...
       document.getElementById('country').value = "";
        ...
        <script type="text/javascript">
          ...
          function deleteproduct(val) {
            ...
            $.ajax({
                type: "POST",
                url: "deleteproductssss.php",
                data:{p_name:val,merchantvalue:val6},
                success: function (data) {
