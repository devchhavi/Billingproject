...
require_once('../include/db.php');
  $p_name = $_POST['p_name'];
 $ResultAllsss = mysqli_query($link, "SELECT * FROM `sale_product_list` WHERE purchase_list_id='$p_name'");
 ...
 $query = "DELETE FROM `sale_product_list` WHERE purchase_list_id=$p_name";
